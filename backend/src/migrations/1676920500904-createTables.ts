...
export class createTables1676920500904 implements MigrationInterface {
    name = 'createTables1676920500904'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "galleries" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "urlImage1" character varying(1000) NOT NULL, "urlImage2" character varying(1000), "urlImage3" character varying(1000), "urlImage4" character varying(1000), "urlImage5" character varying(1000), "urlImage6" character varying(1000), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "adId" uuid, CONSTRAINT "REL_8c0c19667deaf47a54076f7dd0" UNIQUE ("adId"), CONSTRAINT "PK_86b77299615c92db3d68c9c7919" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "ads" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "typeAd" character varying(6) NOT NULL, "title" character varying(200) NOT NULL, "description" character varying(500) NOT NULL, "year" integer NOT NULL, "mileage" integer NOT NULL, "price" numeric(12,2) NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "typeVehicle" character varying(5) NOT NULL, "urlCoverImage" character varying(1000) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_a7af7d1998037a97076f758fc23" PRIMARY KEY ("id"))`);
