...
const InputComment = () => {
  ...
  return (
    <Container>
      {isLoggedIn && <Detail avatarColor={user.avatarColor} name={user.name} />}
      <Form
        style={{
          display: "flex",
      ...
      >
        ...
        <SpansWrapper>
          ...
          <Span onClick={() => setDefaultValue("Incrível")}>Incrível</Span>
          <Span
            onClick={() => setDefaultValue("Recomendarei para meus amigos!")}
          >
