...
const MotorShopProvider = ({ children }: IProvider) => {
  ...
  const [openModalReturnCreateAd, setOpenModalReturnCreateAd] = useState(false);
  const [openModalReturnUpdateAd, setOpenModalReturnUpdateAd] = useState(false);
  const [openModalReturnDeleteAd, setOpenModalReturnDeleteAd] = useState(false);
